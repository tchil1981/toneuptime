...
exports.comedians = [
    {
        comedians: [
            new comedian_1.Comedian('Tom', '', 'images/landscape.jpg', 'description'),
            new comedian_1.Comedian('Brandon', '', 'images/landscape.jpg', 'description')
        ],
        date: {
    ...
    {
        comedians: [
            new comedian_1.Comedian('David', '', 'images/landscape.jpg', 'description'),
            new comedian_1.Comedian('Eddi Muppy', '', 'images/landscape.jpg', 'description')
        ],
        date: {
